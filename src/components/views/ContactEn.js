...
function Contact(props) {
  ...
  return (
    ...
    <div className={classes.div} style={{marginRight:'5.5%',marginTop:75,height:600,margin:'auto'}}>
        <h3 className={classes.title1}>Got any questions?</h3>
        <h3 className={classes.title2}>Get in touch!</h3>
    ...
    <div className={classes.div}>
      ...
      <div className={classes.content}>
        ...
        <Input required name="name" type="text"  placeholder='Name' className={classes.input}/>
        <Input required name="email" type="email"  placeholder='E-mail' className={classes.input}/>
        <Input required name="subject" type="text"  placeholder='Subject' className={classes.input}/>
        <Textarea required name="message" type="text" style={{height:150}}  placeholder='Message' className={classes.input}/>
        {send ? <p className={classes.msg}>Message sent!</p>:''}
