    ...
    <div className={classes.root}>
      ...
      <Accordion className={classes.accordion}>
        ...
        <AccordionDetails className={classes.text}>
          <Typography >
            <strong>O que é a GoodGain?</strong><br/>
            ...
            <strong>Como abro minha conta na GG? </strong><br/>
            ...
            <strong>A GoodGain é legal?</strong><br/>
            ...
            <strong>Quais plataformas estão disponíveis?</strong><br/>
      ...
      <Accordion className={classes.accordion}>
        ...
        <AccordionDetails className={classes.text}>
          <Typography >
            <strong>Como me cadastrar na GoodGain?</strong><br/>
            ...
            <strong>Como recuperar minha senha?</strong><br/>
            ...
            <strong>Posso ter mais de uma conta?</strong><br/>
            <span>Não! É permitida apenas uma conta por CPF.</span><br/>
            <strong>Posso cadastrar mais de 01 console de jogo?</strong><br/>
      ...
      <Accordion className={classes.accordion}>
        ...
        <AccordionDetails className={classes.text}>
          <Typography>
            <strong>O que é a partida rápida? </strong><br/>
            ...
            <strong>Como faço para jogar uma partida rápida? </strong><br/>
            ...
            <strong>Como faço para participar de um campeonato?</strong><br/>
            <span>•	Faça seu cadastro</span>
            <span>•	Transfira algum valor para sua conta digital</span>
            <span>•	Escolha seu jogo favorito</span>
            ...
            <strong>Como reportar o resultado final do jogo? </strong><br/>
            ...
            <strong>O que fazer se meu adversário descumprir o regulamento?</strong><br/>
            ...
            <strong>O que acontece se houver queda de conexão?</strong><br/>
            ...
            <strong>O ID do meu adversário está diferente do ID que aparece no app. O que fazer? </strong><br/>
            ...
            <strong>Como funcionam os campeonatos?</strong><br/>
            ...
            <strong>Quantos jogadores participam dos campeonatos?</strong><br/>
            ...
            <strong>Não fiz o check-in e o campeonato já iniciou. O que fazer?</strong><br/>
            ...
            <strong>Qual a premiação final de cada campeonato? </strong><br/>
            ...
            <strong>Não tenho adversário em alguma fase do campeonato. O que fazer?</strong><br/>
            ...
            <strong>Posso me inscrever em campeonatos com antecedência? </strong><br/>
      ...
      <Accordion className={classes.accordion}>
        ...
        <AccordionDetails className={classes.text}>
          <Typography>
            <strong>Como faço uma transferência pra minha conta na GoodGain e quais formas de pagamento?</strong><br/>
            ...
            <strong>Posso carregar minha conta com cartão de crédito?</strong><br/>
            ...
            <strong>Como solicitar saque do saldo da minha carteira digital? </strong><br/>
            ...
            <strong>Qual prazo para receber a transferência na minha conta? </strong><br/>
            ...
            <strong>Recebi um voucher para utilizar na GoodGain, posso sacar esse valor? </strong><br/>
      ...
      <Accordion className={classes.accordion}>
        ...
        <AccordionDetails className={classes.text}>
          <Typography>
            <strong>Como funciona o ranking geral?</strong><br/>
            ...
            <strong>Quando as premiações são divulgadas?</strong><br/>
            ...
            <strong>Posso trocar a premiação por dinheiro?</strong><br/>
